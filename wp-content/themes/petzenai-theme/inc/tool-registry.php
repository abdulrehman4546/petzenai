...
function pz_get_all_tools() {
    return [
        ...
        // DOG GROOMING (20)
        // ═══════════════════════════════════════════
        ['slug'=>'dog-nail-trimming-guide','title'=>'Dog Nail Trimming Guide & Schedule','cat'=>'dog-grooming','animal'=>'dog','type'=>'guide','kw'=>'dog nail trimming guide','icon'=>'✂️','calc'=>'dog_nail_trimming'],
        ...
        ['slug'=>'dog-shedding-guide','title'=>'Dog Shedding Guide: Control & Solutions','cat'=>'dog-grooming','animal'=>'dog','type'=>'guide','kw'=>'dog shedding guide','icon'=>'🪮','calc'=>'dog_shedding'],
        ['slug'=>'dog-ear-cleaning-guide','title'=>'Dog Ear Cleaning Guide & Schedule','cat'=>'dog-grooming','animal'=>'dog','type'=>'guide','kw'=>'dog ear cleaning guide','icon'=>'👂','calc'=>'dog_ear_cleaning'],
        ['slug'=>'dog-teeth-brushing-guide','title'=>'Dog Teeth Brushing Guide for Beginners','cat'=>'dog-grooming','animal'=>'dog','type'=>'guide','kw'=>'how to brush dog teeth','icon'=>'🦷','calc'=>'dog_teeth_brushing'],
        ...
        ['slug'=>'puppy-first-grooming-guide','title'=>'Puppy First Grooming: Complete Guide','cat'=>'dog-grooming','animal'=>'dog','type'=>'guide','kw'=>'puppy first grooming guide','icon'=>'🐶','calc'=>'puppy_first_grooming'],
        ['slug'=>'dog-coat-type-guide','title'=>'Dog Coat Types: Care Guide for Every Breed','cat'=>'dog-grooming','animal'=>'dog','type'=>'guide','kw'=>'dog coat types care guide','icon'=>'🐩','calc'=>'dog_coat_type'],
        ['slug'=>'dog-eye-cleaning-guide','title'=>'Dog Eye Discharge Cleaning Guide','cat'=>'dog-grooming','animal'=>'dog','type'=>'guide','kw'=>'clean dog eye discharge','icon'=>'👁️','calc'=>'dog_eye_cleaning'],
        ['slug'=>'dog-paw-care-guide','title'=>'Dog Paw Care & Moisturizing Guide','cat'=>'dog-grooming','animal'=>'dog','type'=>'guide','kw'=>'dog paw care guide','icon'=>'🐾','calc'=>'dog_paw_care'],
        ['slug'=>'dog-anal-gland-guide','title'=>'Dog Anal Gland Expression Guide','cat'=>'dog-grooming','animal'=>'dog','type'=>'guide','kw'=>'dog anal gland expression guide','icon'=>'🔬','calc'=>'dog_anal_gland'],
        ['slug'=>'dog-haircut-styles-guide','title'=>'Dog Haircut Styles by Breed Guide','cat'=>'dog-grooming','animal'=>'dog','type'=>'guide','kw'=>'dog haircut styles guide','icon'=>'✂️','calc'=>'dog_haircut_styles'],
        ['slug'=>'long-haired-dog-grooming-guide','title'=>'Long-Haired Dog Grooming: Step by Step','cat'=>'dog-grooming','animal'=>'dog','type'=>'guide','kw'=>'long haired dog grooming','icon'=>'🪮','calc'=>'long_haired_dog_grooming'],
        ['slug'=>'dog-deshedding-guide','title'=>'Dog Deshedding Tools & Techniques Guide','cat'=>'dog-grooming','animal'=>'dog','type'=>'guide','kw'=>'dog deshedding guide','icon'=>'🐕','calc'=>'dog_deshedding'],
        ['slug'=>'dog-grooming-tools-guide','title'=>'Dog Grooming Tools: Complete Buying Guide','cat'=>'dog-grooming','animal'=>'dog','type'=>'guide','kw'=>'dog grooming tools guide','icon'=>'🛒','calc'=>'dog_grooming_tools'],
        ['slug'=>'dog-winter-coat-care','title'=>'Dog Winter Coat Care Guide','cat'=>'dog-grooming','animal'=>'dog','type'=>'guide','kw'=>'dog winter coat care','icon'=>'❄️','calc'=>'dog_winter_coat_care'],
        ['slug'=>'dog-summer-grooming-guide','title'=>'Dog Summer Grooming & Cooling Guide','cat'=>'dog-grooming','animal'=>'dog','type'=>'guide','kw'=>'dog summer grooming tips','icon'=>'☀️','calc'=>'dog_summer_grooming'],
        ['slug'=>'how-to-remove-dog-mats','title'=>'How to Remove Dog Mats & Tangles Safely','cat'=>'dog-grooming','animal'=>'dog','type'=>'guide','kw'=>'how to remove dog mats','icon'=>'✂️','calc'=>'dog_mat_removal'],
        ['slug'=>'dog-tail-grooming-guide','title'=>'Dog Tail Grooming & Care Guide','cat'=>'dog-grooming','animal'=>'dog','type'=>'guide','kw'=>'dog tail grooming','icon'=>'🐕','calc'=>'dog_tail_grooming'],
        ['slug'=>'professional-vs-home-dog-grooming','title'=>'Professional vs Home Dog Grooming: Which Is Better?','cat'=>'dog-grooming','animal'=>'dog','type'=>'guide','kw'=>'professional vs home dog grooming','icon'=>'⚖️','calc'=>'pro_vs_home_grooming'],
        ...
        // DOG NUTRITION (20)
        // ═══════════════════════════════════════════
        ['slug'=>'dog-calorie-calculator','title'=>'Dog Daily Calorie Calculator','cat'=>'dog-nutrition','animal'=>'dog','type'=>'calculator','kw'=>'dog daily calorie calculator','icon'=>'🔢','calc'=>'dog_calorie_calc'],
        ['slug'=>'puppy-feeding-guide','title'=>'Puppy Feeding Guide: How Much & How Often','cat'=>'dog-nutrition','animal'=>'dog','type'=>'guide','kw'=>'puppy feeding guide','icon'=>'🍼','calc'=>'puppy_feeding'],
        ['slug'=>'dog-raw-diet-guide','title'=>'Raw Diet for Dogs: Complete Beginner Guide','cat'=>'dog-nutrition','animal'=>'dog','type'=>'guide','kw'=>'raw diet for dogs guide','icon'=>'🥩','calc'=>'dog_raw_diet'],
        ['slug'=>'dog-homemade-food-guide','title'=>'Homemade Dog Food Guide: Recipes & Nutrition','cat'=>'dog-nutrition','animal'=>'dog','type'=>'guide','kw'=>'homemade dog food guide','icon'=>'🍲','calc'=>'dog_homemade_food'],
        ['slug'=>'best-dog-food-guide','title'=>'How to Choose the Best Dog Food: Complete Guide','cat'=>'dog-nutrition','animal'=>'dog','type'=>'guide','kw'=>'how to choose best dog food','icon'=>'🛒','calc'=>'best_dog_food'],
        ['slug'=>'dog-weight-loss-plan','title'=>'Dog Weight Loss Plan Calculator','cat'=>'dog-nutrition','animal'=>'dog','type'=>'calculator','kw'=>'dog weight loss plan','icon'=>'📉','calc'=>'dog_weight_loss_plan'],
        ['slug'=>'dog-toxic-foods-guide','title'=>'Foods Toxic to Dogs: Complete Safety List','cat'=>'dog-nutrition','animal'=>'dog','type'=>'guide','kw'=>'foods toxic to dogs list','icon'=>'☠️','calc'=>'dog_toxic_foods'],
        ['slug'=>'dog-grain-free-diet-guide','title'=>'Grain-Free Dog Food: Pros, Cons & Safety','cat'=>'dog-nutrition','animal'=>'dog','type'=>'guide','kw'=>'grain free dog food guide','icon'=>'🌾','calc'=>'dog_grain_free_diet'],
        ['slug'=>'dog-protein-requirements','title'=>'Dog Protein Requirements Calculator & Guide','cat'=>'dog-nutrition','animal'=>'dog','type'=>'calculator','kw'=>'dog protein requirements','icon'=>'💪','calc'=>'dog_protein_requirements'],
        ['slug'=>'senior-dog-diet-guide','title'=>'Senior Dog Diet: Best Foods for Aging Dogs','cat'=>'dog-nutrition','animal'=>'dog','type'=>'guide','kw'=>'senior dog diet guide','icon'=>'🐕','calc'=>'senior_dog_diet'],
        ['slug'=>'dog-food-allergies-guide','title'=>'Dog Food Allergies: Signs & Elimination Diet','cat'=>'dog-nutrition','animal'=>'dog','type'=>'guide','kw'=>'dog food allergies guide','icon'=>'🤧','calc'=>'dog_food_allergies'],
        ['slug'=>'dog-supplements-guide','title'=>'Dog Supplements Guide: What Actually Works','cat'=>'dog-nutrition','animal'=>'dog','type'=>'guide','kw'=>'dog supplements guide','icon'=>'💊','calc'=>'dog_supplements'],
        ['slug'=>'dog-hydration-calculator','title'=>'Dog Water Intake Calculator','cat'=>'dog-nutrition','animal'=>'dog','type'=>'calculator','kw'=>'how much water should a dog drink','icon'=>'💧','calc'=>'dog_hydration_calc'],
        ['slug'=>'pregnant-dog-nutrition-guide','title'=>'Pregnant Dog Nutrition & Feeding Guide','cat'=>'dog-nutrition','animal'=>'dog','type'=>'guide','kw'=>'pregnant dog nutrition guide','icon'=>'🐕','calc'=>'pregnant_dog_nutrition'],
        ['slug'=>'dog-treat-calculator','title'=>'Dog Daily Treat Limit Calculator','cat'=>'dog-nutrition','animal'=>'dog','type'=>'calculator','kw'=>'how many treats can I give my dog','icon'=>'🦴','calc'=>'dog_treat_calc'],
        ['slug'=>'working-dog-nutrition','title'=>'Working Dog Nutrition & High-Energy Diet Guide','cat'=>'dog-nutrition','animal'=>'dog','type'=>'guide','kw'=>'working dog nutrition guide','icon'=>'🏋️','calc'=>'working_dog_nutrition'],
        ['slug'=>'dog-digestive-health-diet','title'=>'Dog Digestive Health Diet & Foods Guide','cat'=>'dog-nutrition','animal'=>'dog','type'=>'guide','kw'=>'dog digestive health diet','icon'=>'🫀','calc'=>'dog_digestive_health'],
        ['slug'=>'dog-kidney-disease-diet','title'=>'Dog Kidney Disease Diet Guide','cat'=>'dog-nutrition','animal'=>'dog','type'=>'guide','kw'=>'dog kidney disease diet','icon'=>'🏥','calc'=>'dog_kidney_disease_diet'],
        ['slug'=>'dog-joint-supplement-guide','title'=>'Best Joint Supplements for Dogs Guide','cat'=>'dog-nutrition','animal'=>'dog','type'=>'guide','kw'=>'best joint supplements for dogs','icon'=>'💊','calc'=>'dog_joint_supplement'],
        ['slug'=>'puppy-to-adult-food-transition','title'=>'When to Switch Puppy to Adult Dog Food','cat'=>'dog-nutrition','animal'=>'dog','type'=>'guide','kw'=>'when to switch puppy to adult food','icon'=>'🔄','calc'=>'puppy_adult_transition'],
